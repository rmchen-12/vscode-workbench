...
import './sash.css'
import { IDisposable, dispose, Disposable, DisposableStore } from 'src/base/common/lifecycle';
import { isMacintosh } from 'src/base/common/platform';
import * as types from 'src/base/common/types';
import { EventType, GestureEvent, Gesture } from 'src/base/browser/touch';
import { StandardMouseEvent } from 'src/base/browser/mouseEvent';
import { Event, Emitter } from 'src/base/common/event';
import { getElementsByTagName, EventHelper, createStyleSheet, addDisposableListener, append, $ } from 'src/base/browser/dom';
