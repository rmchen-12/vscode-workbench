...
import { IDisposable, toDisposable, Disposable, combinedDisposable } from 'src/base/common/lifecycle';
import { Event, Emitter } from 'src/base/common/event';
import * as types from 'src/base/common/types';
import { clamp } from 'src/base/common/numbers';
import { range, pushToStart, pushToEnd } from 'src/base/common/arrays';
import { Sash, Orientation, ISashEvent as IBaseSashEvent, SashState } from 'src/base/browser/ui/sash/sash';
import { Color } from 'src/base/common/color';
import { domEvent } from 'src/base/browser/event';
import { $, append, scheduleAtNextAnimationFrame } from 'src/base/browser/dom';
import { SmoothScrollableElement } from 'src/base/browser/ui/scrollbar/scrollableElement';
import { Scrollable, ScrollbarVisibility } from 'src/base/common/scrollable';
export { Orientation } from 'src/base/browser/ui/sash/sash';
