...
import './paneview.css';
import { IDisposable, Disposable, DisposableStore } from 'src/base/common/lifecycle';
import { Event, Emitter } from 'src/base/common/event';
import { domEvent } from 'src/base/browser/event';
import { StandardKeyboardEvent } from 'src/base/browser/keyboardEvent';
import { KeyCode } from 'src/base/common/keyCodes';
import { $, append, trackFocus, EventHelper, clearNode } from 'src/base/browser/dom';
import { Color, RGBA } from 'src/base/common/color';
import { SplitView, IView } from './splitview';
import { isFirefox } from 'src/base/browser/browser';
import { DataTransfers } from 'src/base/browser/dnd';
import { Orientation } from 'src/base/browser/ui/sash/sash';
...
export abstract class Pane extends Disposable implements IView {
  ...
  constructor(options: IPaneOptions) {
    ...
    this.ariaHeaderLabel = options.title;
