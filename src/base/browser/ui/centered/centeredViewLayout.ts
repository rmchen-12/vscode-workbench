...
import { SplitView, Orientation, ISplitViewStyles, IView as ISplitViewView } from 'src/base/browser/ui/splitview/splitview';
import { $ } from 'src/base/browser/dom';
import { Event } from 'src/base/common/event';
import { IView, IViewSize } from 'src/base/browser/ui/grid/grid';
import { IDisposable, DisposableStore } from 'src/base/common/lifecycle';
import { Color } from 'src/base/common/color';
import { IBoundarySashes } from 'src/base/browser/ui/grid/gridview';
