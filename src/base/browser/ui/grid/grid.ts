...
import { tail2 as tail, equals } from 'src/base/common/arrays';
import { orthogonal, IView as IGridViewView, GridView, Sizing as GridViewSizing, Box, IGridViewStyles, IGridViewOptions, IBoundarySashes } from './gridview';
import { Event } from 'src/base/common/event';

export { Orientation, orthogonal, LayoutPriority } from './gridview';
