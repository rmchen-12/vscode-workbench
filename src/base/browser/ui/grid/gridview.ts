...
import { Orientation, Sash } from 'src/base/browser/ui/sash/sash';
import { SplitView, IView as ISplitView, Sizing, LayoutPriority, ISplitViewStyles } from 'src/base/browser/ui/splitview/splitview';
import { Disposable, IDisposable, toDisposable } from 'src/base/common/lifecycle';
import { $ } from 'src/base/browser/dom';
import { tail2 as tail } from 'src/base/common/arrays';
import { Color } from 'src/base/common/color';
import { clamp } from 'src/base/common/numbers';

export { Sizing, LayoutPriority } from 'src/base/browser/ui/splitview/splitview';
