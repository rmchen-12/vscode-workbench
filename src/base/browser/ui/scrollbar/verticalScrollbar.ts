...
import { StandardWheelEvent } from 'src/base/browser/mouseEvent';
...
import { ARROW_IMG_SIZE } from 'src/base/browser/ui/scrollbar/scrollbarArrow';
...
import { Codicon, registerCodicon } from 'src/base/common/codicons';
