...
import * as arrays from 'src/base/common/arrays';
import { IDisposable, Disposable } from 'src/base/common/lifecycle';
import * as DomUtils from 'src/base/browser/dom';
import { memoize } from 'src/base/common/decorators';
...
export class Gesture extends Disposable {
  ...
  private static isTouchDevice(): boolean {
    ...
    return 'ontouchstart' in window || navigator.maxTouchPoints > 0 || (window as Window).navigator.maxTouchPoints > 0;
  }
