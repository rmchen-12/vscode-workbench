...
import * as browser from 'src/base/browser/browser';
import { domEvent } from 'src/base/browser/event';
import { IKeyboardEvent, StandardKeyboardEvent } from 'src/base/browser/keyboardEvent';
...
import { Disposable, DisposableStore, IDisposable, toDisposable } from 'src/base/common/lifecycle';
import * as platform from 'src/base/common/platform';
import { URI } from 'src/base/common/uri';
import { FileAccess, RemoteAuthorities } from 'src/base/common/network';
import { BrowserFeatures } from 'src/base/browser/canIUse';
import { insane, InsaneOptions } from 'src/base/common/insane/insane';
