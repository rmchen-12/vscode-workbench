...
import { Component } from 'src/workbench/common/component';
import { Dimension, size, IDimension } from 'src/base/browser/dom';
import { ISerializableView, IViewSize } from 'src/base/browser/ui/grid/grid';
...
import { assertIsDefined } from 'src/base/common/types';
