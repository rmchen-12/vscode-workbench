...
import { Barrier } from 'src/base/common/async';
import { Disposable } from 'src/base/common/lifecycle';
import { ILifecycleService, BeforeShutdownEvent, WillShutdownEvent, StartupKind, LifecyclePhase, LifecyclePhaseToString } from 'src/workbench/services/lifecycle/common/lifecycle';
