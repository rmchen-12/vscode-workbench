...
import { autorun } from "base/common/observableImpl/autorun";
import { IObservable, BaseObservable, transaction, IReader, ITransaction, ConvenientObservable, IObserver, observableValue, getFunctionName } from "base/common/observableImpl/base";
...
export class FromEventObservable<TArgs, T> extends BaseObservable<T> {
  ...
  constructor(private readonly event: Event<TArgs>, private readonly getValue: (args: TArgs | undefined) => T) {
    super();
  }
